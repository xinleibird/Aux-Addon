...
do
	...
	label:SetPoint('TOPLEFT', unit_buyout_price_input, 'BOTTOMLEFT', -50, -290)
	deposit = label
end

do
    local label = gui.label(frame.parameters, gui.font_size.medium)
    label:SetPoint('TOPLEFT', unit_buyout_price_input, 'BOTTOMLEFT', -200, -24)
